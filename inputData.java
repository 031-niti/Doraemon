...
public class inputData {
    public static void main(String[] args) {
        ...
        System.out.println("Me : Hello, my name is : Niti");
        ...
        System.out.println("Niti : I want to go to the future.");
        System.out.println("Doraemon : Of course, what is the present year?");
        System.out.println("Niti : It is : ");
        int year = in.nextInt();
        System.out.println("Niti : It is : " +year);
